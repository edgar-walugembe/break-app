...
const Card = ({ title, id, price, img }) => {
  return (
    <div className="col-12 md:col-6 lg:col-4">
      <div className="card p-2 flex flex-col items-center relative justify-center rounded bg-white">
        ...
        <div
          className="icon.box absolute mt-0 ml-0 flex items-center justify-center bg-amber rounded"
